...
| components.kserve.dsc | object | `{"managementState":"Managed","modelsAsService":{"managementState":"Removed"},"nim":{"managementState":"Managed"},"rawDeploymentServiceConfig":"Headless","wva":{"managementState":"Removed"}}` | DSC configuration for KServe |
